      ...
      <div className="px-5 py-6 space-y-4">
        ...
        <div className="bg-white rounded-2xl p-5 shadow-sm">
          ...
          <div className="bg-blue-50 border border-blue-100 rounded-xl p-4">
            <p className="text-sm text-blue-800 leading-relaxed">
              <span className="font-semibold">Transparency Rule:</span> Every
              1,000 Ks spend gives you 1 point.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-5 shadow-sm">
          ...
          <p className="text-sm text-gray-600">
            Points are added after each completed order. You can apply your
            points on the Booking page to get an instant discount before
            confirming with KBZPay.
          </p>
        </div>
      </div>
    </div>
